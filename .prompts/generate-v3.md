...
Brand:
B.T.M Enterprise จำหน่ายปั๊มลมสกรู อะไหล่ บริการ PM ซ่อมสกรู. เน้นโทนสีเขียว/ทอง

This is variant 3 of 3.

CREATIVE DIRECTION
A creative director has chosen this direction for variant #3:
Broken grid with diagonal section dividers at 8°, hero text overlapping imagery boundary, service icons as large 200px line drawings floating in negative space — Brutalist wide-tracking caps (Space Grotesk or Syne) with zero-leading stacked numerals for pricing/specs — Unexpected pairing: raw concrete #B0A99A warm grey as 60% canvas meets compressed-air teal #00C2B3 at 30% + aged brass #C8A951 as 10% precision accent, anchored to the palette of a 1990s Thai industrial-zone warehouse converted to gallery (think TCDC building materiality) — Confident disruption, premium without the luxury-brand cliché
