...
Full-bleed hero splits viewport 60/40 with compressor machinery photo left + stacked data panel right, below-fold cards in 3-column asymmetric masonry — Condensed industrial grotesque headlines (think Barlow Condensed heavy) paired with monospace data labels — Bold duotone: machine-black #0D0D0D dominant canvas + electric chartreuse #AEEA00 as the single live accent (gauges, CTAs, dividers), anchored to 1970s German industrial instrument panels — High-voltage precision, feels like a factory floor dashboard
